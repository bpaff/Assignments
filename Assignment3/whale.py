...
import pygame
from pygame.locals import KEYDOWN, QUIT, K_ESCAPE, K_w, K_a, K_s, K_d
...
def draw_everything(screen, mybox, pellets, borders):
    screen.fill((64, 65, 64)) # dark blue
    [pygame.draw.rect(screen, (200, 191, 255), b) for b in borders] # # Deep Sky Blue
    [pygame.draw.rect(screen, (0, 192, 203), p) for p in pellets] # pink
    pygame.draw.rect(screen, (25, 191, 255), mybox) # Deep Sky Blue
...
def create_borders(dims, thickness=2):
    ...
    return [pygame.Rect(0, 0, thickness, h),
            ...
            pygame.Rect(50, 50, thickness, 100),
